            ...
            <Box className={styles.nav}>
                ...
                <Box className={styles.menu} sx={{cursor:'pointer'}}>
                  ...
                  <li className={styles.list_item} onClick={() => router.push("/profile")}> 
                    ...
                    <Avatar alt="Remy Sharp" src="https://images.unsplash.com/photo-1551963831-b3b1ca40c98e" sx={{width:"22px", height:'22px', marginTop:'1px', fontSize:'12px', border: '1px solid black' }} className={styles.icon}/>
                  </li> 
                </Box>
            </Box>
        </Box>
